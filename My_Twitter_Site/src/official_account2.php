...
if($dbh){
   ...
   //データベース更新を実行するSQL文
   $sql_upd = 'UPDATE `user_tb`  SET official_flag = 1 WHERE '.$sql_where;
   $_SESSION['update'] = $sql_upd;
}
?>
<!DOCTYPE html>
<html lang="en">
...
function delRecordAlert(){
   res = confirm("このユーザーに公認バッジを付与しますか.");
   if(res == true){
...
<body>
    ...
    <form action = "official_account3.php" method = "POST" name = "delform">
    <input type = "submit" value = "公認バッジを付与する" onclick = "return delRecordAlert()" class = "submi">
    </form>
</div>
    <?php
