...
<body>
    <h2>こちらは管理者ページです</h2>
    <h2>ユーザの公認バッジ付与ができます</h2> 
    <a href="home_admin.php"><button type="button" class="btn btn-primary">アカウント凍結ページへ</button></a><br><br>
    <a href="logout.php"><button type="button" class="btn btn-danger">ログアウト</button></a><br><br>

    <form method = "POST" action = "official_account2.php">
    <table class = "table">
        <tr class = "tr">
        <td></td>
        <td>ログイン名</td>
        ...
        <div class="submit">
        <input type = "submit" value = "公認バッジを付与する" class = "submi">
